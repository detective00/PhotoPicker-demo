...
public class PhotoPicker {
    ...
    public final static String EXTRA_GRID_COLUMN = "GRID_COLUMN";
    ...
    public static final String SLIDING_INDEX_ACTION = "com.javon.yunphotopicker.sliding";
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setSelected(ArrayList<String> imagesUri) {
            mPickerOptionsBundle.putStringArrayList(EXTRA_SELECTED_PHOTOS, imagesUri);
            return this;
        }
